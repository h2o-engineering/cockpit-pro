/* H2O Studio — Knowledge Model — Knowledge Model v0 captured-chat highlight adapter (Studio distribution mirror).
 *
 ...
 *
 * Provides the read-only captured-chat / highlight compatibility
 *   adapter over those contracts.
 *
 * Publishes H2O.Knowledge.CapturedChatHighlightAdapterV0.
 *
