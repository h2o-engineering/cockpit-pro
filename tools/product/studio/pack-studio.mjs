...
export const ARCHIVE_WORKBENCH_SOURCE_FILES = Object.freeze([
  ...
  "settings/local-folder-sync.panel.js",
  "settings/webdav.panel.js",
  "settings/browser-delivery.panel.js",
  "settings/archive-recovery.panel.js",
  "settings/automation.panel.js",
  "settings/advanced-diagnostics.panel.js",
  "settings/relay-exchange.panel.js",
  "settings/activity-audit.panel.js",
...
// M04-P2-R01 (HDA decision E): read-only byte comparison for the P02 Chrome
// adapter family, consistent with the other mapped comparison helpers, so the
// publisher/activator can verify every packed Sync family against its source.
